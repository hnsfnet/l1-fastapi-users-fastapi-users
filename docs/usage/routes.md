...
The email address is normalized by stripping whitespace and converting to lowercase before lookup, allowing case-insensitive and whitespace-tolerant email matching.
